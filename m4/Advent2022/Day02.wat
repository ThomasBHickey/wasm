...
;; i64list.m4
  ...
  (func $day02b (export "_Day02b")
	...
	(loop $lineLoop
	  (local.set $lineTerm (call $str.readIntoStr (local.get $line)))
	  (local.set $cols (call $str.Csplit (local.get $line) (i32.const 32(;SP;)) ))
...
;; ready to undivert
  ...
  (data (i32.const 271) "aaa\00") (global $gaaa i32 (i32.const 271))
  (data (i32.const 275) "[]\00") (global $gDblBrack i32 (i32.const 275))
  (data (i32.const 278) "[[]]\00") (global $gDblDblBrack i32 (i32.const 278))
  (data (i32.const 283) "123\00") (global $g123text i32 (i32.const 283))
  (data (i32.const 287) "\00") (global $gEmptyString i32 (i32.const 287))
  ...
  (data (i32.const 368) "A X\00") (global $gAX i32 (i32.const 368))
  (data (i32.const 372) "A Y\00") (global $gAY i32 (i32.const 372))
  (data (i32.const 376) "A Z\00") (global $gAZ i32 (i32.const 376))
  (data (i32.const 380) "B X\00") (global $gBX i32 (i32.const 380))
  (data (i32.const 384) "B Y\00") (global $gBY i32 (i32.const 384))
  (data (i32.const 388) "B Z\00") (global $gBZ i32 (i32.const 388))
  (data (i32.const 392) "C X\00") (global $gCX i32 (i32.const 392))
  (data (i32.const 396) "C Y\00") (global $gCY i32 (i32.const 396))
  (data (i32.const 400) "C Z\00") (global $gCZ i32 (i32.const 400))
  (data (i32.const 404) "ZZZ\00") (global $gZZZ i32 (i32.const 404))

;; undiverted
 (global $curMemUsed (mut i32)(i32.const 408))
 (global $maxMemUsed (mut i32)(i32.const 408))
