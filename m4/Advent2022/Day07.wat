...
(func $fileSystemToStr (param $root i32)(result i32)
  ...
  (local.set $strPtr (call $str.mk))
  ;;_testString(`gfilesystemtostr',`in $fileSystemToStr')
  ...
  (call $str.catByte (local.get $strPtr) (i32.const 58(;:;)))
;;_testString(`ggettingparent',`about to get parent name')
  (local.set $parent (call $map.get (local.get $root)(global.get $strParent)))
;;_testString(`ggotparent',`got parent') (call $i32.print(local.get $parent))
...
(func $dirCommand (param $root i32)(param $line i32)
  ...
  (call $i32.print (i32.sub (call $str.getByteLen(local.get $line)) (i32.const 4)))(call $printlf)
   (call $str.printwlf(call $str.mkdata (global.get $gdirCommand:)))
...
;; ready to undivert
  ...
  (data (i32.const 456) "in $cdCommand\00") (global $gcdCommand i32 (i32.const 456))
  (data (i32.const 470) "cd already there!\00") (global $galready i32 (i32.const 470))
  (data (i32.const 488) "in $dirCommand\00") (global $gdirCommand i32 (i32.const 488))
  (data (i32.const 503) "dir name:\00") (global $gdirCommand: i32 (i32.const 503))
  (data (i32.const 513) "in $lsCommand\00") (global $glsCommand i32 (i32.const 513))
  (data (i32.const 527) "ls found dir\00") (global $gfoundir i32 (i32.const 527))
  (data (i32.const 540) "Past Dir command!\00") (global $gpastDirCommand i32 (i32.const 540))
  (data (i32.const 558) "ls handling line\00") (global $ghandling i32 (i32.const 558))
  (data (i32.const 575) "in parseLine\00") (global $ginparseline i32 (i32.const 575))
  (data (i32.const 588) "ZZZ\00") (global $gZZZ i32 (i32.const 588))

;; undiverted
 (global $curMemUsed (mut i32)(i32.const 592))
 (global $maxMemUsed (mut i32)(i32.const 592))
