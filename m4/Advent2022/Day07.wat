...
(func $fileSystemToStr (param $root i32)(result i32)
  ...
  (call $str.catStr (local.get $strPtr)(global.get $strType))
   ;;_testString(`gfilesystemtostr2',`in $fileSystemToStr')
 (call $str.catByte (local.get $strPtr) (i32.const 58(;:;)))
   ;;_testString(`gfilesystemtostr3',`in $fileSystemToStr')
 (call $str.catStr (local.get $strPtr) (call $map.get(local.get $root)(global.get $strType)))
  ;;_testString(`gfilesystemtostr4',`in $fileSystemToStr')
  (call $str.catByte (local.get $strPtr) (i32.const 10(;LF;)))
  ;;_testString(`gfilesystemtostr5',`in $fileSystemToStr')
  (call $str.catStr (local.get $strPtr)(global.get $strName))
  ;;_testString(`gfilesystemtostr6',`in $fileSystemToStr6')
  (call $str.catStr (local.get $strPtr) (call $map.get(local.get $root)(global.get $strName)))
 ;; _testString(`gfilesystemtostr7',`in $fileSystemToStr7')
  (call $str.catByte (local.get $strPtr) (i32.const 10(;LF;)))
  ...
  (loop $childLoop
	(if (i32.lt_s (local.get $childNum)(local.get $numChildren))
	  (then
		...
		(call $str.catByte (local.get $strPtr) (i32.const 32(;SP;)))
		(local.set $childNum (i32.add(local.get $childNum)(i32.const 1)))
		(br $childLoop)
	  )
	)
  )
...
;; ready to undivert
  ...
  (data (i32.const 515) "in $fileSystemToStr8\00") (global $gfilesystemtostr8 i32 (i32.const 515))
  (data (i32.const 536) "about to get parent name\00") (global $ggettingparent i32 (i32.const 536))
  (data (i32.const 561) "got parent\00") (global $ggotparent i32 (i32.const 561))
  (data (i32.const 572) "in $fileSystemToStr9\00") (global $gfilesystemtostr9 i32 (i32.const 572))
  (data (i32.const 593) "in $fileSystemToStra\00") (global $gfilesystemtostra i32 (i32.const 593))
  (data (i32.const 614) "in $fileSystemToStrb\00") (global $gfilesystemtostrb i32 (i32.const 614))
  (data (i32.const 635) "in $fileSystemToStrc\00") (global $gfilesystemtostrc i32 (i32.const 635))
  (data (i32.const 656) "in $cdCommand\00") (global $gcdCommand i32 (i32.const 656))
  (data (i32.const 670) "cd already there!\00") (global $galready i32 (i32.const 670))
  (data (i32.const 688) "in $dirCommand\00") (global $gdirCommand i32 (i32.const 688))
  (data (i32.const 703) "$dirCommand adding new dir\00") (global $gAddingDir i32 (i32.const 703))
  (data (i32.const 730) "here are roots rchildren\00") (global $gshowchildren i32 (i32.const 730))
  (data (i32.const 755) "just pushed $newDir onto $rchildren\00") (global $gPushedChildren i32 (i32.const 755))
  (data (i32.const 791) "new children\00") (global $gAddedDir i32 (i32.const 791))
  (data (i32.const 804) "in $lsCommand\00") (global $glsCommand i32 (i32.const 804))
  (data (i32.const 818) "ls found dir\00") (global $gfoundir i32 (i32.const 818))
  (data (i32.const 831) "Past Dir command!\00") (global $gpastDirCommand i32 (i32.const 831))
  (data (i32.const 849) "ls handling line\00") (global $ghandling i32 (i32.const 849))
  (data (i32.const 866) "in parseLine\00") (global $ginparseline i32 (i32.const 866))
  (data (i32.const 879) "Root value:\00") (global $grootvalue i32 (i32.const 879))
  (data (i32.const 891) "ZZZ\00") (global $gZZZ i32 (i32.const 891))

;; undiverted
 (global $curMemUsed (mut i32)(i32.const 895))
 (global $maxMemUsed (mut i32)(i32.const 895))
