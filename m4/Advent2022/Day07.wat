...
(func $initFileSystem (result i32) ;; returns the initialized root directory
  ...
  (local.set $root (call $mkDir (global.get $strSlash) (global.get $strSlash)))  ;;null parent
...
;; ready to undivert
  ...
  (data (i32.const 446) "in $cdCommand\00") (global $gcdCommand i32 (i32.const 446))
  (data (i32.const 460) "cd already there!\00") (global $galready i32 (i32.const 460))
  (data (i32.const 478) "in $dirCommand\00") (global $gdirCommand i32 (i32.const 478))
  (data (i32.const 493) "in $lsCommand\00") (global $glsCommand i32 (i32.const 493))
  (data (i32.const 507) "ls handling line\00") (global $ghandling i32 (i32.const 507))
  (data (i32.const 524) "in parseLine\00") (global $ginparseline i32 (i32.const 524))
  (data (i32.const 537) "ZZZ\00") (global $gZZZ i32 (i32.const 537))

;; undiverted
 (global $curMemUsed (mut i32)(i32.const 541))
 (global $maxMemUsed (mut i32)(i32.const 541))
