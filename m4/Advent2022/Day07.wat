...
(global $strCd (mut i32) (i32.const 0))
(global $strDir (mut i32) (i32.const 0))
(global $strFile (mut i32) (i32.const 0))
(global $strLs (mut i32) (i32.const 0))
(global $strName (mut i32) (i32.const 0))
(global $strParent (mut i32) (i32.const 0))
(global $strSlash (mut i32) (i32.const 0))
(global $strType (mut i32) (i32.const 0))
...
(func $mkDir (param $name i32)(param $parent i32)(result i32)
  ...
  ;;(call $i32.print (local.get $parent))
  (local.set $dir (call $strMap.mk))
  (if (i32.eqz (local.get  $parent))
	(local.set $parent (local.get $dir)))  ;; parent of itself
 ;; _testString(`gnullparent',`here is the parent just set in $mkDir:')(call $i32.print(local.get $parent))
  (call $map.set
    (local.get $dir)
	(global.get $strType)
	(global.get $strDir))
...
(func $fileSystemToStr (param $root i32)(result i32)
  ...
  (local.set $strPtr (call $str.mk))
   (call $str.printwlf(call $str.mkdata (global.get $gfilesystemtostr)))
 ...
 (call $str.printwlf(call $str.mkdata (global.get $ggotparent))) (call $i32.print(local.get $parent))
  ;;(call $str.catStr (call $map.get (local.get $parent) (global.get $strName)))
  (call $str.catByte (local.get $strPtr) (i32.const 10(;LF;)))
...
(func $dirCommand (param $root i32)(param $line i32)
  (local $dirName i32)(local $newDir i32)
...
;; ready to undivert
  ...
  (data (i32.const 456) "in $fileSystemToStr\00") (global $gfilesystemtostr i32 (i32.const 456))
  (data (i32.const 476) "about to get parent name\00") (global $ggettingparent i32 (i32.const 476))
  (data (i32.const 501) "got parent\00") (global $ggotparent i32 (i32.const 501))
  (data (i32.const 512) "in $cdCommand\00") (global $gcdCommand i32 (i32.const 512))
  (data (i32.const 526) "cd already there!\00") (global $galready i32 (i32.const 526))
  (data (i32.const 544) "in $dirCommand\00") (global $gdirCommand i32 (i32.const 544))
  (data (i32.const 559) "dir name:\00") (global $gdirCommand: i32 (i32.const 559))
  (data (i32.const 569) "in $lsCommand\00") (global $glsCommand i32 (i32.const 569))
  (data (i32.const 583) "ls found dir\00") (global $gfoundir i32 (i32.const 583))
  (data (i32.const 596) "Past Dir command!\00") (global $gpastDirCommand i32 (i32.const 596))
  (data (i32.const 614) "ls handling line\00") (global $ghandling i32 (i32.const 614))
  (data (i32.const 631) "in parseLine\00") (global $ginparseline i32 (i32.const 631))
  (data (i32.const 644) "ZZZ\00") (global $gZZZ i32 (i32.const 644))

;; undiverted
 (global $curMemUsed (mut i32)(i32.const 648))
 (global $maxMemUsed (mut i32)(i32.const 648))
