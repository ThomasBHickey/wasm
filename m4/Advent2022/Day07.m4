...
(func $setName(param $dir i32)(param $type i32)(call $map.set(local.get $dir)(global.get $strName)(local.get $type)))
(func $getChildren(param $dir i32)(result i32) (call $map.get(local.get $dir)(global.get $strChildren)))
(func $setChildren(param $dir i32)(param $type i32)(call $map.set(local.get $dir)(global.get $strChildren)(local.get $type)))
(func $getParent(param $dir i32)(result i32) (call $map.get(local.get $dir)(global.get $strParent)))
(func $setParent(param $dir i32)(param $type i32)(call $map.set(local.get $dir)(global.get $strParent)(local.get $type)))
(func $getLength(param $dir i32)(result i32) (call $map.get(local.get $dir)(global.get $strLength)))
(func $setLength(param $dir i32)(param $type i32)(call $map.set(local.get $dir)(global.get $strLength)(local.get $type)))
