...
(func $fileSystemToStr (param $root i32)(result i32)
  ...
  _testString(`gfilesystemtostr1',`in $fileSystemToStr')
 ...
 ;; _testString(`gfilesystemtostr7',`in $fileSystemToStr7')
  (call $str.catByte (local.get $strPtr) _LF)
  _testString(`gfilesystemtostr8',`in $fileSystemToStr8')
...
_testString(`ggotparent',`got parent') (call $i32.print(local.get $parent))
  ...
  (call $str.catStr (local.get $strPtr)(call $childrenToStr(call $map.get(local.get $root)(global.get $strChildren))))
   _testString(`gfilesystemtostrc',`in $fileSystemToStrc')
 (call $str.catByte (local.get $strPtr) _LF)
  (local.get $strPtr)
)
...
(func $dirCommand (param $root i32)(param $line i32)
  ...
  _testString(`gAddingDir',`$dirCommand adding new dir')
  ...
  _testString(`gshowchildren',`here are roots rchildren')
  ...
  _testString(`gPushedChildren',`just pushed $newDir onto $rchildren')
  ;;(call $printwlf (call $i32list.toStr (local.get $rchildren)))
  _testString(`gAddedDir',`new children')
  ;;(call $printwlf (call $fileSystemToStr(local.get $root)))
)
...
(func $Day07a (export "_Day07a")
  ...
  _testString(`grootvalue',`Root value:')(call $printwlf (call $i32.toStr (local.get $root)))
  (call $printwlf (call $fileSystemToStr(local.get $root)))
