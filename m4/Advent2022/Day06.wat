...
(func $lookForDup (param $stream i32)(param $start i32)(param $len i32)(result i32)
  ...
  (local.set $pos (local.get $start)) (local.set $pos (i32.add(local.get $pos)(i32.const 1)))  ;; first pos to check against $target
  (local.set $lastPos (i32.add (local.get $start)(local.get $len))) (local.set $lastPos (i32.sub(local.get $lastPos)(i32.const 1)))
  (loop $checkLoop
 ...
 ;; _testString(`gtest1',` :pos, $lookForDup returns 0')
  (return (i32.const 0))  ;; no dup found
)
...
(func $checkStream (param $stream i32)(param $pos i32)(param $winSize i32)(result i32)
  ...
  (local.set $pos (i32.add(local.get $pos)(i32.const 1))) (local.set $winSize (i32.sub(local.get $winSize)(i32.const 1)))
...
(func $day06a (export "_Day06a")
  ...
  (call $i32.print (call $checkStream (local.get $dataStream) (i32.const 0) (global.get $fullWinSize)))(call $printlf)
...
;; ready to undivert
  ...
  (data (i32.const 396) "ZZZ\00") (global $gZZZ i32 (i32.const 396))

;; undiverted
 (global $curMemUsed (mut i32)(i32.const 400))
 (global $maxMemUsed (mut i32)(i32.const 400))
